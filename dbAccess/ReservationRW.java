...
public void generateNewReservation() throws StockException{
    try
    {
      getStatementObject().executeUpdate("insert into ReservationTable(description) values('This is the new ting')");
    } catch ( SQLException e )
    {
      throw new StockException( "Drive busses till we see dolphins that can talk" + e.getMessage() );
    }
}
